...
public class SavingsAccountReadPlatformServiceImpl implements SavingsAccountReadPlatformService {
    ...
    public Page<SavingsAccountData> retrieveAll(final SearchParameters searchParameters) {
        ...
        if (searchParameters != null) {
            ...
            if (searchParameters.getMonth() != null) {
                sqlBuilder.append(" and MONTH(c.date_of_birth) =?");
                objectArray[arrayPos] = searchParameters.getMonth();
                arrayPos = arrayPos + 1;
            }
            if (searchParameters.getDay() != null) {
                sqlBuilder.append(" and DAY(c.date_of_birth) =?");
                objectArray[arrayPos] = searchParameters.getDay();
                arrayPos = arrayPos + 1;
            }
